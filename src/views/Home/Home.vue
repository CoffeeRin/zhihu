<template>
    <div class="home-box">
        ...
        <!--  轮播图 -->
        <van-swipe class="swiper-box" :autoplay="3000" indicator-color="cornflowerblue" vertical>
        ...
        <van-list v-model:loading="loading" :finished="finished" finished-text="No more" @load="onLoad">
            <van-cell v-for="(it, idx) in news_list">
                <van-divider dashed v-if="idx > 0">{{ it.date }}</van-divider>
...
import NewsItem from './NewsItem.vue' //导入NewsItem
